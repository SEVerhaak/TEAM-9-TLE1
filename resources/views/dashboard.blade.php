...
{{--                @if($vacancy->application_stage == 1)--}}
                    ...
                    <div class="geld">
                        <p> €{{$invited->vacancy->salary}} bruto per maand</p>
                    ...
                    <div class="tijd">
                        <p> {{$invited->vacancy->time_hours}} uur per week</p>
                        <svg xmlns="http://www.w3.org/2000/svg" width="{{$width ?? "17.5"}}"
                             height="{{$height ?? "17.5"}}"
                             viewBox="0 0 17.5 17.5">
...
{{--                @if($vacancy->application_stage == 0)--}}
                    ...
                    <div class="geld">
                        <p> €{{$pending->vacancy->salary}} bruto per maand</p>
                        <svg xmlns="http://www.w3.org/2000/svg" width="{{$width ?? "17.5"}}"
                             height="{{$height ?? "17.5"}}"
                             viewBox="0 0 17.5 17.5">
                            <path id="Icon_fa-solid-coins" data-name="Icon fa-solid-coins"
                    ...
                    <div class="tijd">
                        <p> {{$pending->vacancy->time_hours}} uur per week</p>
                        <svg xmlns="http://www.w3.org/2000/svg" width="{{$width ?? "17.5"}}"
                             height="{{$height ?? "17.5"}}"
                             viewBox="0 0 17.5 17.5">
                            <path id="Icon_fa-solid-clock" data-name="Icon fa-solid-clock"
...
{{--                @if($vacancy->application_stage == 2)--}}
                    ...
                    <div class="geld">
                        <p> €{{$denied->vacancy->salary}} bruto per maand</p>
                        <svg xmlns="http://www.w3.org/2000/svg" width="{{$width ?? "17.5"}}"
                             height="{{$height ?? "17.5"}}"
                             viewBox="0 0 17.5 17.5">
                            <path id="Icon_fa-solid-coins" data-name="Icon fa-solid-coins"
                    ...
                    <div class="tijd">
                        <p> {{$denied->vacancy->time_hours}} uur per week</p>
                        <svg xmlns="http://www.w3.org/2000/svg" width="{{$width ?? "17.5"}}"
                             height="{{$height ?? "17.5"}}"
                             viewBox="0 0 17.5 17.5">
                            <path id="Icon_fa-solid-clock" data-name="Icon fa-solid-clock"
