...
<section class="Aangenomen">
    ...
    <div class="aangenomenicon">
        ...
        <svg xmlns="http://www.w3.org/2000/svg" width="8%" height="8%" viewBox="0 0 28.5 28.5">
            ...
            <path id="Icon_fa-solid-circle-check" data-name="Icon fa-solid-circle-check" class="cls-1" d="M14.25,28.5A14.25,14.25,0,1,0,0,14.25,14.25,14.25,0,0,0,14.25,28.5Zm6.29-16.866-7.125,7.125a1.33,1.33,0,0,1-1.887,0L7.966,15.2a1.334,1.334,0,0,1,1.887-1.887l2.616,2.616,6.179-6.184a1.334,1.334,0,1,1,1.887,1.887Z"/>
        </svg>
    </div>
</section>
...
<section class="InAfwachting">
    ...
    <div class="text-icon-content-container">
        <h2>In Afwachting</h2>
        <svg xmlns="http://www.w3.org/2000/svg" width="{{$width ?? "8%"}}" height="{{$height ?? "8%"}}" viewBox="0 0 17.5 17.5">
            <style>
                .cls-1 {
                    fill: #fff;
                }
...
<section class="denied">
    ...
    <div class="text-icon-content-container">
        ...
        <svg xmlns="http://www.w3.org/2000/svg" width="8%" height="8%" viewBox="0 0 30.5 30.5">
            ...
            <path id="Icon_fa-solid-circle-exclamation" data-name="Icon fa-solid-circle-exclamation" class="cls-1" d="M15.25,30.5A15.25,15.25,0,1,0,0,15.25,15.25,15.25,0,0,0,15.25,30.5Zm0-22.875a1.426,1.426,0,0,1,1.43,1.43v6.672a1.43,1.43,0,0,1-2.859,0V9.055A1.426,1.426,0,0,1,15.25,7.625ZM13.344,20.969a1.906,1.906,0,1,1,1.906,1.906A1.906,1.906,0,0,1,13.344,20.969Z"/>
        </svg>
    </div>
</section>
