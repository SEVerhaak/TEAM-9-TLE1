                            ...
                            @endif
                                    @if ($application->application_stage == 1)
                                        <div class="bericht">
                                            ...
                                            naar de werkgever</a>
                                            <svg xmlns="http://www.w3.org/2000/svg" width="39.67"
                                            height="39.67" viewBox="0 0 39.67 39.67">
                                                <defs>
                                                    <style>
                                                        .cls-1 {
                                                        fill: #fff;
